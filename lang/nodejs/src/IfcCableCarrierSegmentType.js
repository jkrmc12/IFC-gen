...
const IfcCableCarrierSegmentTypeEnum = require('./IfcCableCarrierSegmentTypeEnum')
const IfcFlowSegmentType = require('./IfcFlowSegmentType')

/**
 * http://www.buildingsmart-tech.org/ifc/IFC4/final/html/link/ifccablecarriersegmenttype.htm
 */
module.exports = class IfcCableCarrierSegmentType extends IfcFlowSegmentType {
