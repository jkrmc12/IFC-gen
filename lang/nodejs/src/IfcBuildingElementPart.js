...
const IfcBuildingElementPartTypeEnum = require('./IfcBuildingElementPartTypeEnum')
const IfcElementComponent = require('./IfcElementComponent')

/**
 * http://www.buildingsmart-tech.org/ifc/IFC4/final/html/link/ifcbuildingelementpart.htm
 */
module.exports = class IfcBuildingElementPart extends IfcElementComponent {
