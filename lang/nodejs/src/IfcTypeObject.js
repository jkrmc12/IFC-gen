 ...
 */
module.exports = class IfcTypeObject extends IfcObjectDefinition {
  
    constructor(globalId) {
        super(globalId)
        	this.ApplicableOccurrence = null  // optional
	this.HasPropertySets = null  // optional
	this.Types = null  // inverse
