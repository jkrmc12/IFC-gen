...
const IfcElementAssemblyTypeEnum = require('./IfcElementAssemblyTypeEnum')
const IfcElement = require('./IfcElement')

/**
 * http://www.buildingsmart-tech.org/ifc/IFC4/final/html/link/ifcelementassembly.htm
 */
module.exports = class IfcElementAssembly extends IfcElement {
  
    constructor(globalId) {
        super(globalId)
        	this.AssemblyPlace = null  // optional
