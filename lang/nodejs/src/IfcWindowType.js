...
const IfcWindowTypeEnum = require('./IfcWindowTypeEnum')
const IfcWindowTypePartitioningEnum = require('./IfcWindowTypePartitioningEnum')
 ...
 */
module.exports = class IfcWindowType extends IfcBuildingElementType {
  
    constructor(globalId, predefinedType, partitioningType) {
        super(globalId)
		this.PredefinedType = predefinedType
		this.PartitioningType = partitioningType

        	this.ParameterTakesPrecedence = null  // optional
	this.UserDefinedPartitioningType = null  // optional
