...
const IfcElectricDistributionBoardTypeEnum = require('./IfcElectricDistributionBoardTypeEnum')
const IfcFlowControllerType = require('./IfcFlowControllerType')

/**
 * http://www.buildingsmart-tech.org/ifc/IFC4/final/html/link/ifcelectricdistributionboardtype.htm
 */
module.exports = class IfcElectricDistributionBoardType extends IfcFlowControllerType {
