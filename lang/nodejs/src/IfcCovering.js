...
const IfcCoveringTypeEnum = require('./IfcCoveringTypeEnum')
 ...
 */
module.exports = class IfcCovering extends IfcBuildingElement {
  
    constructor(globalId) {
        super(globalId)
        	this.PredefinedType = null  // optional
	this.CoversSpaces = null  // inverse
	this.CoversElements = null  // inverse
