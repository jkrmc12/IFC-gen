...
const IfcStairFlightTypeEnum = require('./IfcStairFlightTypeEnum')
 ...
 */
module.exports = class IfcStairFlight extends IfcBuildingElement {
  
    constructor(globalId) {
        super(globalId)
        	this.NumberOfRisers = null  // optional
	this.NumberOfTreads = null  // optional
	this.RiserHeight = null  // optional
	this.TreadLength = null  // optional
