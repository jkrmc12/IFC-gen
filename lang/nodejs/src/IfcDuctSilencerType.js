...
const IfcDuctSilencerTypeEnum = require('./IfcDuctSilencerTypeEnum')
const IfcFlowTreatmentDeviceType = require('./IfcFlowTreatmentDeviceType')

/**
 * http://www.buildingsmart-tech.org/ifc/IFC4/final/html/link/ifcductsilencertype.htm
 */
module.exports = class IfcDuctSilencerType extends IfcFlowTreatmentDeviceType {
