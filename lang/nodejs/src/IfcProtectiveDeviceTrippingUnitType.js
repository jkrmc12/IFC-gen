...
const IfcProtectiveDeviceTrippingUnitTypeEnum = require('./IfcProtectiveDeviceTrippingUnitTypeEnum')
const IfcDistributionControlElementType = require('./IfcDistributionControlElementType')

/**
 * http://www.buildingsmart-tech.org/ifc/IFC4/final/html/link/ifcprotectivedevicetrippingunittype.htm
 */
module.exports = class IfcProtectiveDeviceTrippingUnitType extends IfcDistributionControlElementType {
