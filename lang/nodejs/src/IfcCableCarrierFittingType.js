...
const IfcCableCarrierFittingTypeEnum = require('./IfcCableCarrierFittingTypeEnum')
const IfcFlowFittingType = require('./IfcFlowFittingType')

/**
 * http://www.buildingsmart-tech.org/ifc/IFC4/final/html/link/ifccablecarrierfittingtype.htm
 */
module.exports = class IfcCableCarrierFittingType extends IfcFlowFittingType {
