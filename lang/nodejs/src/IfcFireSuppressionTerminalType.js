...
const IfcFireSuppressionTerminalTypeEnum = require('./IfcFireSuppressionTerminalTypeEnum')
const IfcFlowTerminalType = require('./IfcFlowTerminalType')

/**
 * http://www.buildingsmart-tech.org/ifc/IFC4/final/html/link/ifcfiresuppressionterminaltype.htm
 */
module.exports = class IfcFireSuppressionTerminalType extends IfcFlowTerminalType {
