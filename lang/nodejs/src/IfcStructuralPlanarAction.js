...
const IfcStructuralSurfaceActivityTypeEnum = require('./IfcStructuralSurfaceActivityTypeEnum')
const IfcStructuralSurfaceAction = require('./IfcStructuralSurfaceAction')

/**
 * http://www.buildingsmart-tech.org/ifc/IFC4/final/html/link/ifcstructuralplanaraction.htm
 */
module.exports = class IfcStructuralPlanarAction extends IfcStructuralSurfaceAction {
