...
const IfcSystemFurnitureElementTypeEnum = require('./IfcSystemFurnitureElementTypeEnum')
const IfcFurnishingElement = require('./IfcFurnishingElement')

/**
 * http://www.buildingsmart-tech.org/ifc/IFC4/final/html/link/ifcsystemfurnitureelement.htm
 */
module.exports = class IfcSystemFurnitureElement extends IfcFurnishingElement {
