...
const IfcAirToAirHeatRecoveryTypeEnum = require('./IfcAirToAirHeatRecoveryTypeEnum')
const IfcEnergyConversionDeviceType = require('./IfcEnergyConversionDeviceType')

/**
 * http://www.buildingsmart-tech.org/ifc/IFC4/final/html/link/ifcairtoairheatrecoverytype.htm
 */
module.exports = class IfcAirToAirHeatRecoveryType extends IfcEnergyConversionDeviceType {
