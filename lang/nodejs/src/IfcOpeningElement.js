...
const IfcOpeningElementTypeEnum = require('./IfcOpeningElementTypeEnum')
 ...
 */
module.exports = class IfcOpeningElement extends IfcFeatureElementSubtraction {
  
    constructor(globalId) {
        super(globalId)
        	this.PredefinedType = null  // optional
	this.HasFillings = null  // inverse
