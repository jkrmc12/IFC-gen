...
const IfcExternalSpatialElementTypeEnum = require('./IfcExternalSpatialElementTypeEnum')
const IfcRelSpaceBoundary = require('./IfcRelSpaceBoundary')
const IfcExternalSpatialStructureElement = require('./IfcExternalSpatialStructureElement')

/**
 * http://www.buildingsmart-tech.org/ifc/IFC4/final/html/link/ifcexternalspatialelement.htm
 */
module.exports = class IfcExternalSpatialElement extends IfcExternalSpatialStructureElement {
