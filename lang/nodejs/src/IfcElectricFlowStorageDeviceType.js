...
const IfcElectricFlowStorageDeviceTypeEnum = require('./IfcElectricFlowStorageDeviceTypeEnum')
const IfcFlowStorageDeviceType = require('./IfcFlowStorageDeviceType')

/**
 * http://www.buildingsmart-tech.org/ifc/IFC4/final/html/link/ifcelectricflowstoragedevicetype.htm
 */
module.exports = class IfcElectricFlowStorageDeviceType extends IfcFlowStorageDeviceType {
