...
const IfcCompressorTypeEnum = require('./IfcCompressorTypeEnum')
const IfcFlowMovingDeviceType = require('./IfcFlowMovingDeviceType')

/**
 * http://www.buildingsmart-tech.org/ifc/IFC4/final/html/link/ifccompressortype.htm
 */
module.exports = class IfcCompressorType extends IfcFlowMovingDeviceType {
