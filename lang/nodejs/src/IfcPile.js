...
const IfcPileTypeEnum = require('./IfcPileTypeEnum')
const IfcPileConstructionEnum = require('./IfcPileConstructionEnum')
const IfcBuildingElement = require('./IfcBuildingElement')

/**
 * http://www.buildingsmart-tech.org/ifc/IFC4/final/html/link/ifcpile.htm
 */
module.exports = class IfcPile extends IfcBuildingElement {
  
    constructor(globalId) {
        super(globalId)
        	this.PredefinedType = null  // optional
	this.ConstructionType = null  // optional
